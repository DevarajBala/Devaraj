...
public class StepDefinition {
	...
	//Search hotel Page**************
		...
		public void user_Select_the_credit_card_expiry_date() throws Throwable {
			WebElement List6 = driver.findElement(By.xpath("//select[@id='cc_exp_month']"));
		...
		public void user_Select_the_credit_card_expiry_Year() throws Throwable {
			WebElement List7 = driver.findElement(By.xpath("//select[@id='cc_exp_year']"));
			Select S3 = new Select(List7);
		...
		public void user_Enter_the_CCV_number_of_the_credit_card() throws Throwable {
			WebElement List8 = driver.findElement(By.xpath("//input[@id= 'cc_cvv']"));
			List8.sendKeys("100");
		}
		...
		public void user_Click_the_Book_Now_Button_to_book_the_hotel() throws Throwable {
			WebElement List9 = driver.findElement(By.xpath("//input[@id= 'book_now']"));
			List9.click();
			
		}		
	//Booking Confirmation and logout
		@When("^Check the confimation using the Text Booking Confirmation$")
		public void check_the_confimation_using_the_Text_Booking_Confirmation() throws Throwable {
		    Assert.assertTrue(driver.findElement(By.xpath("//td[contains(text(),'Booking Confirmation')]")).isDisplayed());
		}

		@When("^Logout the application$")
		public void logout_the_application() throws Throwable {
			WebElement List10 = driver.findElement(By.xpath("//input[@id='logout']"));
			List10.click();
		}
}
